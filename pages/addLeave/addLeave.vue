<template>
	<view>
		...
		<input placeholder="离校/否" v-model="isLeave">
		<label>是否显示当前时间<text class="subRed"></text></label>
		<switch :checked="isShowTime" @click="isShowTime = !isShowTime">
			是否显示当前时间
		</switch>
	<br>
	<br>
	...
	<view class="pickerView">
		...
		<label>紧急联系人<text class="subRed">非必填</text></label>
		...
		<input placeholder="不输入则不显示" v-model="roomInfo" />
		
		<label>一级审批人<text class="subRed">*必填</text></label>
		<input placeholder="一级审批人姓名" v-model="oneCheck" />
		<label>一级审批人身份<text class="subRed">非必填</text></label>
